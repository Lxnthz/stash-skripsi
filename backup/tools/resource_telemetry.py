...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Always-on host-side resource telemetry daemon: writes pg_growth.csv, mongo_growth.csv, unstructured_totals.csv, and resource_usage.csv."
    )
    ...
    _log("telemetry", info_tag(), f"out_dir={out_dir} interval={int(args.interval_sec)}s")
